...
class PhotoWCT(nn.Module):
    def __init__(self):
        ...
        self.e1 = VGGEncoder(1).cuda()
        self.d1 = VGGDecoder(1).cuda()
        self.e2 = VGGEncoder(2).cuda()
        self.d2 = VGGDecoder(2).cuda()
        self.e3 = VGGEncoder(3).cuda()
        self.d3 = VGGDecoder(3).cuda()
        self.e4 = VGGEncoder(4).cuda()
        self.d4 = VGGDecoder(4).cuda()
    ...
    def transform(self, cont_img, styl_img, cont_seg, styl_seg):
        ...
        #styl_img = Variable(styl_img.cuda())
