...
class SkySegWrapper:
    def __init__(self):
        ...
        self._segmentation_module = SegmentationModule(net_encoder, net_decoder, crit)
        self._segmentation_module.cuda(0)
    ...
    def run(self, image_path):
        ...
        self._segmentation_module.cuda()

        # Main loop
        return self._get_proba(self._segmentation_module, loader_val)

    def _get_proba(self, segmentation_module, loader):
        segmentation_module.eval()
        ...
        for i, batch_data in enumerate(loader):
            ...
            with torch.no_grad():
                ...
                for img in img_resized_list:
                    ...
                    # forward pass
                    pred_tmp = segmentation_module(feed_dict, segSize=segSize)
                    pred = pred + pred_tmp.cpu() / len([300, 400, 500, 600])
